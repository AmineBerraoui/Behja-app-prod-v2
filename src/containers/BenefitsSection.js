...
const BenefitsSection = () => {
  ...
  return (
    <section
      className={`flex flex-col items-center justify-center bg-gradient-to-r from-primary-600 to-primary-700 w-full mt-16`}
      id="benefitssection"
    >
      <div className={`w-[90%] ${i18n.language === "Ar" ? "items-end" : "items-start"} py-28 `}>
        <p
          className={`heading-02-semibold ${
            i18n.language === "Ar" ? "text-end" : "text-start"
          } text-primary-50 mb-24`}
          style={{ whiteSpace: "pre-line" }}
        >
          {t("Behja is Designed\nfor Future Homeowners\nWho Seek Flexibility and Convenience!")}
        </p>
        <div
          className={`flex flex-col gap-5 md:${
